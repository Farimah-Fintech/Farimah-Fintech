  ...
  return (
    ...
    >
      ...
      <div className="mb-20">
        ...
        <div className="my-6 text-primary dark:text-emerald-300 border shadow-sm border-emerald-300 rounded-md p-3">
      ...
      <p className={`mb-2 text-primary dark:text-secondary-focus opacity-80 ${loginPending && "animate-pulse"}`}>
      ...
      <div className="mt-2 text-primary flex justify-between">
        ...
        <span role="button" className="ms-auto dark:text-primary-focus">
          {t("text.resend_code")}
        </span>
      </div>
      {/* end::Count down */}
